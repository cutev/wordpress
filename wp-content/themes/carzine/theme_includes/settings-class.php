...
class carzine_Settings_API {
    ...
    function show_navigation() {
        ...
        $html .='<div class="admin-premium-theme">
                <p>Do you need more?If yes , CarZine Premium is about to launch in the next few days..!</p> 
                <p>Sliders , widgetized areas, custom post types</p> 
                .You can view the premium here by pressing the button below.</p>';
        $html .='<a target="blank"  href="'.esc_url('http://takimi.info/carzine/#premium').'">Go Premium - View Features</a>
